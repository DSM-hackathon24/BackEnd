package com.example.backend.infrastructure.mail.service;
...
public class MailService {
    ...
    private String randomCode(MailRequest request){
    ...
    @Transactional
    public void execute(MailRequest request) throws Exception {
        ...
        msgg += "<div class=\"\"><div class=\"aHl\"></div><div id=\":2j\" tabindex=\"-1\"></div><div id=\":2q\" class=\"ii gt\" jslog=\"20277; u014N:xr6bB; 4:W251bGwsbnVsbCxbXV0.\"><div id=\":1l\" class=\"a3s aiL \"><div class=\"adM\">\n" +
                ...
                "                        <tbody>\n" +
                "                            <tr>\n" +
                "                                <img style=\"width:720px;height:180px;\" src=\"https://media.discordapp.net/attachments/822309850700054548/1113302665015861389/Frame_24.jpg?width=1140&height=253\"/>\n" +
                "                            </tr>\n" +
                "                            <tr>\n" +
                "\t\t\t\t\t\t\t<td style=\"color:#999\">\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t<td style=\"color:#999\">\n" +
                "\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin:20px 0;padding:0\"><strong style=\"color:#333\">안녕하세요. <em style=\"color:#66A696;font-style:normal\">소화전</em> 입니다.</strong></p>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t<span><strong style=\"color:#0ld;font-size:30px;\">" + randomCode(request) + "</strong></span>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t</div>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin:20px 0;padding:0\"><strong style=\"color:#333\">소화전을 이용해 주셔서 감사합니다.</strong></p>\n" +
                "\t\t\t\t\t\t\t\t\t\t</td>\n" +
                "\t\t\t\t\t\t\t\t\t\t<td width=\"40\" style=\"color:#999\"></td>\n" +
                "\t\t\t\t\t\t\t\t\t</tr>\n" +
                "\t\t\t\t\t\t\t\t\t<tr>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t</p>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t<p style=\"font-size:11px;margin:0;margin-top:10px;padding:0\">© 소화전. All Rights Reserved.</p>\n" +
                "\t\t\t\t\t\t\t\t\t\t</td>\n" +
                "\t\t\t\t\t\t\t\t\t\t<td width=\"40\" style=\"color:#999\"></td>\n" +
                "\t\t\t\t\t\t\t\t\t</tr>\n" +
                "\t\t\t\t\t\t\t\t\t<tr>\n" +
        ...
        message.setFrom(new InternetAddress("todayisdiary@gmail.com", "소화전"));//보내는 사람
